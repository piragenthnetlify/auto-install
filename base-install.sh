...
command apt install git sudo curl wget docker docker.io nano network-manager wireless-tools firmware-realtek linux-headers-generic build-essential dkms gdebi software-properties-common -y
